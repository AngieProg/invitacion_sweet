...
const Invitado = () => (
  <section className="mt-10 flex justify-center">
    <div className="flex flex-col justify-center items-center w-[400px] h-[400px] py-6 border-4 border-separate border-dark-pink  text-center relative">
      <img src={esqIzqEspacio} className="absolute top-0 left-0" />
      <CardFormato titulo1="Apreciable" titulo2="Nombre del Invitado" />
      <p className="font-montserrat text-sm w-[300px] text-dark-brown">
